...
public class LocalPassenger implements Passenger {
    ...
    public LocalPassenger(Context context, String fName, String lName, String email, String password, String nic, String accountType) {
    ...
    public void signUp() {
        ...
        String json = "{\"fName\":\"" + fName + "\",\"lName\":\"" + lName + "\",\"email\":\"" + email + "\",\"password\":\"" + password + "\",\"accountType\":\"" + accountType + "\", \"identifier\":\"" + nic + "\"}";
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    showToast("Local Passenger Account Successfully created...");
